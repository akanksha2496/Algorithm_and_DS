...
| 			Topic/Question			                                            |	Code in Python                              
|-----------------------------------|:------------------:|:-----------------:|
|Check whether a given number n is a power of 2 or 0                            |[java](Bit_Manipulation/Check_Pow_2.py)        
|Count number of bits needed to be flipped to convert A to B                    |[java](Bit_Manipulation/Count_Bits_Flip_A_B.py) 
|Find the two non-repeating elements in an array of repeating elements          |[java](Bit_Manipulation/Find_Non_Repeating.py)  
|Find the next greater and next smaller number with same number of set bits     |[java](Bit_Manipulation/Next_Number.py)        
...
| 			Topic/Question			                                            |	Code in Python                              
|-----------------------------------|:------------------:|:-----------------:|
|check if given binary tree is BST or not.                              |[py](Tree/BinarySearchTree/Minimal_Tree.py)
